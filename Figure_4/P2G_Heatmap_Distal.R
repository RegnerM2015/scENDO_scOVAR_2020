plotPeak2GeneHeatmap.distal <- function(
  ...
  # if(!file.exists(readRDS("/datastore/nextgenout5/share/labs/francolab/scENDO_scOVAR_Proj/scATAC-seq_Processing/HGSOC_ATAC/HGSOC/Peak2GeneLinks/seATAC-Group-KNN.rds"))){
  #   stop("seATAC does not exist! Did you change paths? If this does not work, please try re-running addPeak2GeneLinks!")
  # }
  # if(!file.exists(readRDS("/datastore/nextgenout5/share/labs/francolab/scENDO_scOVAR_Proj/scATAC-seq_Processing/HGSOC_ATAC/HGSOC/Peak2GeneLinks/seRNA-Group-KNN.rds"))){
  #   stop("seRNA does not exist! Did you change paths? If this does not work, please try re-running addPeak2GeneLinks!")
  # }
  mATAC <- readRDS("/datastore/nextgenout5/share/labs/francolab/scENDO_scOVAR_Proj/scATAC-seq_Processing/HGSOC_ATAC/HGSOC/Peak2GeneLinks/seATAC-Group-KNN.rds")[p2g$idxATAC, ]
  ...
  mRNA <- readRDS("/datastore/nextgenout5/share/labs/francolab/scENDO_scOVAR_Proj/scATAC-seq_Processing/HGSOC_ATAC/HGSOC/Peak2GeneLinks/seRNA-Group-KNN.rds")[p2g$idxRNA, ]
  ...
  KNNList <- as(metadata(readRDS("/datastore/nextgenout5/share/labs/francolab/scENDO_scOVAR_Proj/scATAC-seq_Processing/HGSOC_ATAC/HGSOC/Peak2GeneLinks/seRNA-Group-KNN.rds"))$KNNList, "list")
